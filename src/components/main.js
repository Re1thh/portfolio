    ...
    <div className="main-container">
      ...
      <div className="inner-container">
        <div className="above-container">
          <div className="left-container-inner" style={{ display: "flex" }}>
            <div className="left-container-photo">
              <img
                src="https://i.postimg.cc/7Y3BCvhv/DSC-0308.jpg"                alt=""
                className="image"
              />
            </div>
            <div className="right-container-desc">
              <h1 className="title">Revanth Reddy</h1>
          ...
          <div className="right-container-inner">
            <ul className="details">
              ...
              <li className="detail">
                {" "}
                <b className="boldtags"> Date of Birth</b>: 03-06-1998
              </li>
              <li className="detail">
                {" "}
                <b className="boldtags">Email</b>: revanthreddy889@gmail.com
              </li>
              <li className="detail">
                {" "}
                <b className="boldtags"> Contact No</b>: +918500597380
              </li>
              <li className="detail">
                {" "}
        ...
        <div className="below-container">
          ...
          <div className="ICONS">
            <a
              href="https://www.linkedin.com/in/revanth-reddy-thipparthi-348506274"
              target={`_blank`}
              className="link"
            >
